        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function checkStatus() {
                try {
                    ...
                    const response = await fetch(`https://wablast.hakkuryuu7z.my.id/wa-engine/api/status?session=${userId}`);
            ...
            window.logoutDevice = async function() {
                if (confirm('Yakin ingin mengeluarkan WhatsApp ini?')) {
                    try {
                        await fetch('https://wablast.hakkuryuu7z.my.id/wa-engine/logout', { 
                            method: 'POST',
